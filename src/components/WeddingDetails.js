          ...
          <div className="col-sm-10">
            ...
            <div className="wedding-details margin-bottom">
              ...
              <div className="w-detail left">
                ...
                <h5>Wednesday, 12th February 2025</h5>
                <p>
                  A turmeric paste made from freshly ground turmeric mixed with
                  mustard oil is applied to the groom’s body by his mother and
                  other married female as well as male relatives. Following
                  this, he is bathed with water that was procured earlier in the
                  morning.
                </p>
              </div>
              ...
              <div className="w-detail right">
                ...
                <h4 className="title">
                  Reception
                  <br />
                  (वर-वधु स्वागत समारोह)
                </h4>
                <h5>Wednesday, 19th February 2025</h5>
                <p>
                  The wedding reception is a celebratory gathering where the
                  newlyweds are formally introduced as a couple to extended
                  family and friends. Rituals include blessings from elders and
                  gift-giving by guests to the bride and groom, symbolizing
                  acceptance of their union and wishing them prosperity and
              ...
              <div className="w-detail left">
                ...
                <p>
                  Look at the most passionate ceremony ever. We wish happiness
